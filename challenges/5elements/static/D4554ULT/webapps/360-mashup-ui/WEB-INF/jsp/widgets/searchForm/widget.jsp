...
<config:getOption var="getValueFromUrl" name="getValueFromUrl" defaultValue="false" />
...
<render:renderScript position="READY">
	...
	<c:if test="${getValueFromUrl == 'true'}">
		$('#${cssId} input[name=${optionInputName}]').enableGetValueFromUrl('${optionInputName}');
	</c:if>
