/**
 * Name: jquery.select7
 * Copyright: 2013 Se7enSky studio
 * Upstream-version: 1.2.3
 * License: MIT
 * Homepage: https://github.com/SE7ENSKY/jquery-select7
 * Description: add style/images to your select tags. 
 */
  ...
  plugin = function($) {
    ...
    Select7 = (function() {
      ...
      Select7.prototype.open = function() {
        ...
        _ref = this.items;
        if(this.config.visibleOptionCount != undefined)
        	$dropList.css("max-height", (this.config.visibleOptionCount*30)+"px");
    ...
    return $.fn.select7 = function(options) {
      var args, method;
      ...
      return this.each(function() {
        ...
        if (!select7) {
          select7 = new Select7(this, typeof method === 'object' ? options : {});
