...
<config:getOption var="defaultYValue" name="defaultYValue" defaultValue="null" />
...
/* Chart Options */
var opts = (<config:getOption name="dataProcessor" defaultValue="function(data) { return data; }" />)(${data});
opts.chartImage = '<c:url value="/resources/highcharts/images/chart_table.png" />';
opts.chartName = 'tableChart';
opts.chartDisplayName = '<i18n:message code="tablechart_name" javaScriptEscape="true" />';
...
opts.plotOptions = {
    series: { baseUrl: <string:escape escapeType="jsonValue"><url:url value="${baseUrl}" feeds="${feeds}" xmlEscape="false" keepQueryString="true" forceRefineOn="${forceRefineOnFeeds}"><url:page value="1"/></url:url></string:escape> }
};
