...
<widget:widget extraCss="mobileRefines" varCssId="cssId">
	...
	<widget:content extraCss="facets">
			...
			<c:otherwise>
				...
				<search:forEachFacet
					...
					<c:remove var="noResults" />
						...
						<table class="facet table table-striped table-grid table-hierarchical table-facets table-hover table-layout ${cookieValue}">
		...
		<c:if test="${noResults == false}">
				<%-- If widget has no Feed --%>&& search:hasFeeds(feeds) == true}">
