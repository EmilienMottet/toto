...
def create_router(templates: Jinja2Templates):
    router = APIRouter()
    @router.put("/challenges/5_us3r-4g3n7-15-4n-1n73rn4710n4l-574nd4rd.html")
    ...
    @router.post("/challenges/5_us3r-4g3n7-15-4n-1n73rn4710n4l-574nd4rd.html")
    def solve_challenge(body: bytes = Depends(get_body)):
        ...
        if data["id"] in numbers and data["number"] == numbers[data["id"]]["number"]:
            del numbers[data["id"]]
            return {"message": "You did it! You are a master! Here is your flag: 6_wh3r3_15_4z1z.html"}
